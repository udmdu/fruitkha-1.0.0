					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul class="nav justify-content-end">
								...
								<li><a href="shop-pg1.html">Shop</a></li>
					...
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="error-text">
								...
								<p>Have Fun Shopping at L'huile Naturelle !</p>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="footer-box about-widget">
						...
						<p>L'huile Naturelle pioneered the spa industry in Bacolod City conforming to high standards of excellence.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch">
						...
						<ul>
							<li>Barangay Villamonte, Bacolod City</li>
							<li>support@LhuileNaturelle.com</li>
							<li>+63 956 165 9469</li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2023 - <a href="">Emdee</a>,  All Rights Reserved.<br>
					</p>
				</div>
